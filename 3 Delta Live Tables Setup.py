...
# MAGIC %run ./Utils/Define-Functions $uc_status="Disabled"
...
# MAGIC %md
# MAGIC You can find DLT Pipeline code notebook in *4 - Delta Live Tables (SQL)*
...
# MAGIC 
# MAGIC It will take some time for pipeline to start. While waiting - explore `4 - Delta Live Tables (SQL)` notebook to see the actual code used to create it.
